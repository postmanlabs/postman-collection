var util = require('../util'),
    ...
    */
    ...
    characterDecodeHashMap = {
        [characterSetEnum.iso88591]: function (encodedString) {
            return getLatin(encodedString);
        },
        [characterSetEnum.utf8]: function (encodedString) {
            if (!supportsBuffer) {
                return;
            }
            return Buffer.from(encodedString, BINARY).toString(characterSetEnum.UTF8);
        }
    },
