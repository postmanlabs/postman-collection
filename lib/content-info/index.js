var fileType = require('file-type'),
    ...
    */
    ...
    getMimeInfo = function (contentType, responseStream, responseBody) {
        ...
        // if contentType is not detected to
        if (!contentType) {
            contentType = 'text/plain';
        }
        normalised = mimeFormat.lookup(contentType);
        _.assign(mime, {
            mimeType: normalised.type, // sanitised mime type base
            format: normalised.format, // format specific to the type returned
            charset: normalised.charset || UTF8,
            defaultExtension: mimeType.extension(normalised.source) || E
        });
        return mime;
    },
...
module.exports = {
    ...
    *
    * @param {String} response - response object of the postman
    ...
    */
    contentInfo: function (response) {
        ...
        return _.extend(mimeInfo, fileName);
    },
