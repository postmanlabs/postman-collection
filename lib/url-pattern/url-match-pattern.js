var _ = require('../util').lodash,
    ...
    regexes = {
        ...
        starMatcher: '*',
        starReplacement: '.*',
        validProtocolTester: '^(' + ALLOWED_PROTOCOLS_REGEX + ')://',
...
_.assign(UrlMatchPattern.prototype, /** @lends UrlMatchPattern.prototype */ {
    ...
    getProtocols: function () {
        return this._matchPatternObject ? this._matchPatternObject.protocols : [];
    },
...
_.assign(UrlMatchPattern, /** @lends UrlMatchPattern */ {
    ...
    /**
     * RegEx for testing a URL to have a valid protocol
     * @readOnly
     * @type {String}
     */
    validProtocolTester: regexes.validProtocolTester
});
