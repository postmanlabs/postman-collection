    ...
    /** @lends util */ {
        ...
        inherit: function(child, base) {
            ...
            child.prototype = Object.create(
                _.isFunction(base) ? base.prototype : base,
                {
                    constructor: {
                        value: child,
                        enumerable: false,
        ...
        inSuperChain: function(obj, key, value) {
            return obj
                ? obj[key] === value || _.inSuperChain(obj.super_, key, value)
                : false;
        },
        ...
        randomString: function(length) {
            ...
            for (i = 0; i < length; i++) {
                result[i] =
                    ASCII_SOURCE[(Math.random() * ASCII_SOURCE_LENGTH) | 0];
            }
...
util = {
     ...
     */
    btoa:
        typeof btoa !== "function" && typeof Buffer === "function"
            ? function(data) {
