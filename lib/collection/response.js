...
_.assign(Response, /** @lends Response */ {
    ...
    createFromNode: function (response, cookies) {
        ...
        if (response.timingStart) {
             ...
             * @property {Number} offset.secureConnect - timestamp when SSL handshaking process is completed
     ...
     *     sslHandshake: Number,  // duration of SSL handshake
    ...
    timingPhases: function (timings) {
        ...
        if (offset.secureConnect) {
            phases.sslHandshake = offset.secureConnect - offset.connect;
