var util = require('../util'),
    ...
    */
    getFileNameFromDispositionHeader = function (dispositionHeader, contentType) {
        var defaultFileName = {
...
_.assign(Response, /** @lends Response */ {
    ...
    /**
     * @public
     * Guesses the mime type by lookup in mimeFormat
    ...
    mimeInfo: function (type, disposition) {
        ...
        var normalised = mimeFormat.lookup(type),
            info = {},
            parsedFileName = getFileNameFromDispositionHeader(disposition, normalised.source);
        _.assign(info, {
            type: normalised.type, // sanitised mime type base
            format: normalised.format, // format specific to the type returned
