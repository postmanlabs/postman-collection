var util = require('../util'),
    ...
    contentDispositionParser = require('content-disposition'),
    ...
    *
    * @private
    * @param {String} contentDispositionHeader -Content-disposition Header from the response
    * @param {string} contentType -The sanitized content type
    * @returns {Object}
    */
    parseContentDispositionHeader = function (contentDispositionHeader, contentType) {
        ...
        parsedContentDisposition = contentDispositionParser.parse(contentDispositionHeader);
        filename = parsedContentDisposition.parameters.filename;
        matches = filenameMatchRegex.exec(filename);
