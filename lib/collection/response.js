 ...
 * @property {Number} [timings.socket] - when the http module's socket event fires (relative to timings.start)
 * @property {Number} [timings.lookup] - when the net module's lookup event fires (relative to timings.start)
 * @property {Number} [timings.connect] - when the net module's connect event fires (relative to timings.start)
 * @property {Number} [timings.response] - when the http module's response event fires (relative to timings.start)
