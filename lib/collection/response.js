...
_.assign(Response.prototype, /** @lends Response.prototype */ {
     ...
     *
     * @returns {Object} size
     * @returns {Number} size.body - size of the response body
     * @returns {Number} size.header - size of the response header
     * @returns {Number} size.total - total size of the response
     * @returns {Number} size.resourceBytes - size of the resource
     * @todo write unit tests
     */
    size: function () {
        var sizeInfo = {
