...
_.assign(Response.prototype, /** @lends Response.prototype */ {
    update: function (options) {
        ...
        // save additional info from request for subsequent processing
        this._details = httpReasons.lookup(options.code);
        this._details.name = _.choose(options.reason, options.status, this._details.name);
        this._details.code = options.code;
        options._reasonFromServer && (this._details.fromServer = true);
...
_.assign(Response.prototype, /** @lends Response.prototype */ {
    ...
    details: function () {
        if (this._details.code !== this.code) {
            this._details = httpReasons.lookup(this.code);
