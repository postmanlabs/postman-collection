 ...
 * @property {Number} [timingStart] - timestamp of the start of the request (in Unix Epoch milliseconds)
 * @property {Object} [timings] - event timestamps of request in millisecond resolution relative to timingStart
 * @property {Number} [timings.socket] - when the http module's socket event fires
 * @property {Number} [timings.lookup] - when the net module's lookup event fires
 * @property {Number} [timings.connect] - when the net module's connect event fires
 * @property {Number} [timings.response] - when the http module's response event fires
 * @property {Number} [timings.end] - when the last bytes of the response are received
 * @property {Object} [timingPhases] - durations of each request phase in millisecond
 * @property {Object} [timingPhases.wait] - duration of socket initialization
 * @property {Object} [timingPhases.dns] - duration of DNS lookup
 * @property {Object} [timingPhases.tcp] - duration of TCP connection
 * @property {Object} [timingPhases.firstByte] - duration of HTTP server response
 * @property {Object} [timingPhases.download] - duration of HTTP download
 * @property {Object} [timingPhases.total] - duration entire HTTP round-trip
 *
...
_.assign(Response.prototype, /** @lends Response.prototype */ {
    update: function (options) {
        ...
        _.mergeDefined(this, /** @lends Response.prototype */ {
             ...
             * @type {Number}
             */
            timingStart: options.timingStart,

            /**
             * Event timestamps of request in millisecond resolution relative to timingStart
             *
             * @type {Object}
             */
            ...
            /**
             * Durations of each request phase in millisecond
             *
             * @type {Object}
             */
            timingPhases: options.timingPhases,
