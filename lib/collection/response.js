...
_.assign(Response.prototype, /** @lends Response.prototype */ {
     ...
     */
    text: function () {
        var charset = this.getCharset(this);
        return (this.stream ? util.bufferOrArrayBufferToString(this.stream, charset) : this.body);
    },
    ...
    getCharset: function() {
        var contentType = this.headers.one('content-type') && this.headers.one('content-type').value;
        return contentType ? charset(contentType) : 'utf-8';
    }
