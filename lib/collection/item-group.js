 ...
 * @property {Array<ItemGroup~definition|Item~definition>=} [items]
 * @property {Array<RequestAuth~definition>=} [auth]
 * @property {Array<Event~definition>=} [events]
 *
 * @example
 * {
...
_.inherit((
    ...
    ItemGroup = function PostmanItemGroup (definition) {
        ...
        _.merge(this, /** @lends ItemGroup.prototype */ {
             ...
             */
            items: new PropertyList(ItemGroup._createNewGroupOrItem, this, definition &&
                (definition.items || definition.item)), // @todo pluralise
             ...
             * });
             */
            events: new EventList(this, definition &&
                (definition.events || definition.event)) // @todo pluralise
        });
    }), Property);
...
_.extend(ItemGroup, /** @lends ItemGroup */ {
    ...
    _createNewGroupOrItem: function (item) {
        return item && ((item.items || item.item) && (new ItemGroup(item)) || (new Item(item)));
    },
    /**
