...
_.assign(ItemGroup.prototype, /** @lends ItemGroup.prototype */ {
     ...
     * Also sets(override) for its Item or ItemGroup
     *
     * @private
     * @param {String} key
     * @param {*} value
     * @param {Object} options
     * @param {Boolean} options.self - set to self (default: true)
     * @param {Boolean} options.eachItem - set to each Item of the current ItemGroup
     * @param {Boolean} options.eachItemGroup - set to each ItemGroup of the current ItemGroup
     * @returns {ItemGroup}
     */
    setProtocolProfileBehavior: function (key, value, options) {
        // set on current ItemGroup unless options.self is falsy
        if (!(options && options.hasOwnProperty('self') && !options.self)) {
            Item.prototype.setProtocolProfileBehavior.call(this, key, value);
        }

        // set on each Item of the current ItemGroup
        if (options && options.eachItem) {
            this.forEachItem(function (item) {
                Item.prototype.setProtocolProfileBehavior.call(item, key, value);
            });
        }

        // set on each ItemGroup of the current ItemGroup
        if (options && options.eachItemGroup) {
            this.forEachItemGroup(function (itemGroup) {
                Item.prototype.setProtocolProfileBehavior.call(itemGroup, key, value);
            });
        }
     ...
     * Also inherits from the parent ItemGroup(s).
     *
     * @private
     * @param {Object} options
     * @param {Object} options.inherit - inherit from parent (default: true)
     * @returns {Object}
     *
     */
