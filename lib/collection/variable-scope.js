...
_.inherit((
     ...
     * @param {MutationTracker~definition} [options.mutations] Enable mutation tracking
     *
    ...
    VariableScope = function PostmanVariableScope (definition, layers, options) {
        ...
        var values = definition && definition.values, // access the values (need this var to reuse access)
            ...
            mutations = (definition && definition.mutations) || (options && options.mutations),
            ii,
            i;
        ...
        // enable mutation tracking (and restore previously tracked mutations)
        if (mutations) {
...
_.assign(VariableScope.prototype, /** @lends VariableScope.prototype */ {
    ...
    set: function (key, value, type) {
        ...
        this.mutations && this.mutations.track(MUTATIONS.SET, key, value);
    },
    ...
    unset: function (key) {
        ...
        // track the change if mutation tracking is enabled
        this.mutations && this.mutations.track(MUTATIONS.UNSET, key);
    },
