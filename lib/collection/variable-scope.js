...
_.assign(VariableScope.prototype, /** @lends VariableScope.prototype */ {
    ...
    /**
     * Using this function, one can sync the values of this variable list from an existing VariableScope JSON.
     *
     * @param {Object} obj A JSON representation of a VariableScope instance, obtained via a .toJSON call.
     * @param {Boolean=} [track] A flag that indicates whether or not to track synced variables.
     *
     * @returns {Object}
     */
    syncVariablesFromScope: function (obj, track) {
        return this.values.syncFromObject(_.transform(obj.values, function (agg, record) {
            agg[record.key] = { value: record.value, type: record.type };
        }, {}), track);
    },
