var _ = require('../util').lodash,
    ...
    Substituter = require('../superstring').Substituter,
...
_.extend(Property, /** @lends Property */ {
    ...
    replaceSubstitutions: function (str, variables) {
        ...
        // if variables object is not an instance of substituter then ensure that it is an array so that it becomes
        // compatibule with the constructor arguments for a substituter
        !Substituter.isInstance(variables) && !_.isArray(variables) && (variables = _.tail(arguments));
        return Substituter.box(variables).parse(str).toString();
    },
    ...
    replaceSubstitutionsIn: function (obj, variables, mutate) {
        ...
        // convert the variables to a substituter object (will not reconvert if already substituter)
        variables = Substituter.box(variables);
