...
_.inherit((
    ...
    Property = function PostmanProperty (definition) {
        ...
        src && _.assignIn(this, /** @lends Property.prototype */ {
            /* jshint -W069 */
            /**
             ...
             */
            id: src.id || (this._ ? this._postman_id : undefined),
             ...
             * @optional
             */
            disabled: (definition && _.has(definition, 'disabled')) ? Boolean(definition.disabled) : undefined
        });
...
_.assignIn(Property.prototype, /** @lends Property.prototype */ {
    /**
...
_.assignIn(Property, /** @lends Property */ {
    /**
    ...
    replaceSubstitutionsIn: function (obj, variables, mutate) {
        ...
        return _.mergeWith(mutate ? obj : {}, obj, function customizer(objectValue, sourceValue) {
            if (!_.isString(sourceValue)) {
                _.forOwn(sourceValue, function (value, key) {
                    sourceValue[key] = customizer(null, value);
                });

                return sourceValue;
            }

            return self.replaceSubstitutions(sourceValue, variables);
        });
    }
});
