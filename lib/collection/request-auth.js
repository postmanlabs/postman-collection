...
_.inherit((
    ...
    RequestAuth = function PostmanRequestAuth (options) {
        ...
        _.assignIn(this, /** @lends RequestAuth.prototype */ {
            /**
...
_.assignIn(RequestAuth.prototype, /** @lends RequestAuth.prototype */ {
    /**
...
_.assignIn(RequestAuth, /** @lends RequestAuth */ {
    types: {},
    ...
    addType: function (handler, name) {
        ...
        var AuthHandler = function PostmanAuthHandler () { }, // eslint-disable-line no-empty-function
