var _ = require('../util').lodash,
    ...
    /**
     * Whitelisted protocol profile behaviors.
     *
     * @private
     * @type {String}
     *
     * @todo change type to array for supporting multiple behaviors
     */
    PROTOCOL_PROFILE_BEHAVIORS = 'disableBodyPruning',
...
_.inherit((
    ...
    Item = function PostmanItem (definition) {
        ...
        _.mergeDefined(this, /** @lends Item.prototype */ {
             ...
             */
            protocolProfileBehavior: definition && definition.protocolProfileBehavior &&
                _.pick(definition.protocolProfileBehavior, PROTOCOL_PROFILE_BEHAVIORS)
        });
    }), Property);
