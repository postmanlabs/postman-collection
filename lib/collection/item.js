var _ = require('../util').lodash,
    ...
    extractProtocolProfileBehavior = function (entity) {
        ...
        return (entity && (ppb = entity.protocolProfileBehavior) && typeof ppb === OBJECT) ? ppb : {};
    };
...
_.assign(Item.prototype, /** @lends Item.prototype */ {
     ...
     *
     */
    getProtocolProfileBehavior: function (options) {
        var protocolProfileBehavior = extractProtocolProfileBehavior(this);

        if (options && options.hasOwnProperty('inherit') && !options.inherit) {
            return protocolProfileBehavior;
        }

        // inherit protocolProfileBehavior from parent
