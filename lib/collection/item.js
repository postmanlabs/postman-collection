...
_.assign(Item.prototype, /** @lends Item.prototype */ {
    ...
    /**
     * Sets the request for the current item to the provided request object.
     *
     * @param {Object} request - The request object to be set within the current item.
     */
    ...
    /**
     * Sets the list of responses for the current item to the provided responses array.
     *.
     * @param {Object[]} responses - The responses Array to be set within the current item.
     */
    setResponses: function (responses) {
        this.responses = new PropertyList(Response, this, responses);
    },
    ...
    getAuth: function () {
        ...
        if (this.request.auth && (auth = this.request.auth.current())) {
            return auth;
        }

        auth = this.findInParents('auth');
        return auth ? auth.current() : undefined;
    },
