...
_.assign(Item.prototype, /** @lends Item.prototype */ {
    ...
    getAuth: function () {
        ...
        // lookup on parent, if item has an auth defined but is empty
        return (this.request && (requestAuth = this.request.auth) && requestAuth.type) ?
            requestAuth : this.findInParents('auth');
    },
