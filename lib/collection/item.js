...
_.assign(Item.prototype, /** @lends Item.prototype */ {
    ...
    /**
     * Set, update or delete protocol profile behavior for the current Item.
     *
    ...
    setProtocolProfileBehavior: function (obj) {
        // bail out if obj is not an Object and have non-string key
        ...
        // set protocolProfileBehavior if value is present
        if (obj.hasOwnProperty('value')) {
            this.protocolProfileBehavior[obj.key] = obj.value;
        }
        // otherwise delete protocolProfileBehavior having the given key name
        else if (this.protocolProfileBehavior.hasOwnProperty(obj.key)) {
            delete this.protocolProfileBehavior[obj.key];
        }
