 ...
 * child domains.)
 * @property {Boolean=} [session] Indicates whether this is a Session Cookie. (A transient cookie, which is deleted at the
 * end of an HTTP session.)
 ...
 * specified here.
 * @property {String} [extensions[].name] Name of the extension.
...
_.inherit((
     ...
     * var Cookie = require('postman-collection').Cookie,
     *     myCookie = new Cookie('myAwesomeCookie=myValue;Path=/;Expires=Sun, 04-Feb-2018 14:18:27 GMT;Secure;HttpOnly;Priority=HIGH');
     *
