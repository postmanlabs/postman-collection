 ...
 * @property {Array<(Item~definition|ItemGroup~definition)>} [items] Items are the basic unit for a Postman collection.
 ...
 * @property {Object<Variable~definition>} [variables] Collection variables allow you to define a set of variables,
...
_.inherit((
    ...
    Collection = function PostmanCollection (definition, environments) {
        ...
        _.extend(this, /** @lends Collection.prototype */ {
             ...
             * });
             */
            variables: new VariableList(this, definition && (definition.variables || definition.variable),
                environments), // @todo pluralise
...
_.extend(Collection.prototype, {
    ...
    toJSON: function () {
        return {
            ...
            events: this.events ? this.events.toJSON() : undefined,
            variables: this.variables ? this.variables.toJSON() : undefined,
