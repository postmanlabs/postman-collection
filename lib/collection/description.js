 ...
 * @constructor
 *
 * @param definition {Description~definition|String} The content of the description can be passed as a string when it is
 * in `text/plain` format or otherwise be sent as part of an object adhering to the {@link Description~definition}
