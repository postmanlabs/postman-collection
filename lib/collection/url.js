var _ = require('../util').lodash,
    ...
    HTTPS_PORT = '443',
    HTTP_PORT = '80',
    PATH_RESOURCE_MEDIA_TYPE_SEPARATOR = '.',
    PATH_SEPARATOR = '/',
...
_.assign(Url, /** @lends Url */ {
    ...
    parse: function (url) {
        ...
        pathVariables = _.transform(url.path, function (res, segment) {
            ...
            if (
                _.startsWith(segment, PATH_VARIABLE_IDENTIFIER) &&
                ...
                res.push({
                    key: segment.slice(1).split(PATH_RESOURCE_MEDIA_TYPE_SEPARATOR)[0]
                }); // remove path variable prefix and media type suffix.
            }
        }, []);
