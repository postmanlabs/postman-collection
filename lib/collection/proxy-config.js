...
_.assign(ProxyConfig.prototype, /** @lends ProxyConfig.prototype */ {
    ...
    getProxyUrl: function (urlStr) {
        ...
        !_.isEmpty(urlStr) && (protocolInUrl = urlStr.split(PROTOCOL_HOST_SEPARATOR)[0]);
        protocolInUrl && (protocol = protocolInUrl);

        return protocol + PROTOCOL_HOST_SEPARATOR + this.host + ':' + this.port;
    },
