var _ = require('../util').lodash,
    ...
    ALLOWED_PROXY_PROTOCOLS = ['http', 'socks4', 'socks4a', 'socks5', 'socks5h'],
    // 'http+https://*:*/*'
...
* @property {String=} [protocol = 'http'] The proxy protocol. Allowed: 'http', 'socks4', 'socks4a', 'socks5', 'socks5h'.
...
_.assign(ProxyConfig.prototype, /** @lends ProxyConfig.prototype */ {
    ...
    update: function (options) {
        ...
        _.isString(options.protocol) &&
            _.includes(ALLOWED_PROXY_PROTOCOLS, options.protocol) && (this.protocol = options.protocol);
    ...
    getProxyUrl: function () {
        ...
        return this.protocol + PROTOCOL_HOST_SEPARATOR + auth + this.host + COLON + this.port;
    },
