...
_.assign(ProxyConfig.prototype, /** @lends ProxyConfig.prototype */ {
     ...
     */
    validateMatchPattern: function(matchPattern) {
    ...
    test: function(urlStr) {
        ...
        */
        ...
        matchRegexObject = this.validateMatchPattern(this.match);
     ...
     * @param {Object=} [matchRegexObject] The regex object generated by the validateMatchPattern function.
