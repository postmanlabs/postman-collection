...
* @property {SshConfig} sshTunnelConfig Configuration required to establish a SSH Tunnel
*
...
_.assign(ProxyConfig.prototype, /** @lends ProxyConfig.prototype */ {
    ...
    update: function (options) {
        ...
        var parsedUrl,
            ...
            sshTunnelConfig = options.sshTunnelConfig;
        ...
        this.sshTunnelConfig.update(SshConfig.isSshConfig(sshTunnelConfig) ?
            sshTunnelConfig : new SshConfig(sshTunnelConfig));
    },
