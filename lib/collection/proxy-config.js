...
_.assign(ProxyConfig.prototype, /** @lends ProxyConfig.prototype */ {
    ...
    update: function (options) {
        ...
        _.isString(options.host) && (this.host = url.parse(options.host).hostname);
    ...
    test: function(urlStr) {
        var protocol = Url.isUrl(urlStr) ? urlStr.protocol : _.trimEnd(url.parse(urlStr || '').protocol || E, COLON);
