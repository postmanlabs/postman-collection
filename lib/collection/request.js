...
_.extend(Request.prototype, /** @lends Request.prototype */ {
    ...
    toJSON: function () {
        ...
        // TODO: add toJSON() to a PropertyList. This can only be done when everything that goes in a PropertyList
        // has a toJSON()
        headers = this.headers ? this.headers.map(function (header) {
