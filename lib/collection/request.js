 ...
 * @property {Array<Header~definition>} [headers] The headers that should be sent as a part of this request.
...
_.extend(Request.prototype, /** @lends Request.prototype */ {
     ...
     *
     * @todo - this function is way simpler with ignore case support in property list. needs to be simplified asap
     */
    ...
    toJSON: function () {
        ...
        return {
            ...
            url: url,
            method: this.method,
            headers: this.headers && this.headers.count() ? this.headers.toJSON() : undefined,
            body: body,
            auth: auth,
