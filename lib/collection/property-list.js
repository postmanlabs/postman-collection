...
_.assignIn(PropertyList.prototype, /** @lends PropertyList.prototype */ {
    ...
    each: function (iterator, context) {
        _.forEach(this.members, iterator.bind(context || this.__parent));
    },
    ...
    find: function (rule, context) {
        if (_.isFunction(rule)) {
            rule = rule.bind(context || this);
        }
        return _.find(this.members, rule);
    },
    ...
    map: function (iterator, context) {
        !context && (context = this);
        return _.map(this.members, iterator.bind(context));
    },
