...
_.assign(PropertyList.prototype, /** @lends PropertyList.prototype */ {
    ...
    filter: function (rule, context) {
        return _.filter(this.members, _.isFunction(rule) ? rule.bind(context || this) : rule);
    },
    ...
    find: function (rule, context) {
        return _.find(this.members, _.isFunction(rule) ? rule.bind(context || this) : rule);
    },
    ...
    map: function (iterator, context) {
        return _.map(this.members, _.isFunction(iterator) ? iterator.bind(context || this.__parent) : iterator);
    },
