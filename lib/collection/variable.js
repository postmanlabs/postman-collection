 ...
 * about how to resolve the variable value from an external source. The structure depends on the source `type` field.
 *
 * @example
 * {
 *     "id": "my-var-1",
 ...
 * }
 *
 * @example Secret variable with localvault source
 * {
 *     "id": "my-secret-var",
 *     "key": "apiKey",
 *     "value": "",
