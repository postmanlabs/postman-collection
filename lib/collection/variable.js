 ...
 * @property {Object=} [ref] - Optional reference object for external secret resolution. Contains metadata
 * about how to resolve the variable value from an external source (e.g., secret manager).
 *
 * @example
 * {
 *     "id": "my-var-1",
 ...
 *         "secretArn": "arn:aws:secretsmanager:us-east-1:123:secret:api-key"
 *     }
 * }
 */
_.inherit((
...
_.assign(Variable.prototype, /** @lends Variable.prototype */ {
    ...
    update (options) {
        ...
        _.has(options, 'ref') && (this.ref = options.ref);
    }
});
...
_.assign(Variable, /** @lends Variable */ {
    ...
    types: {
        ...
        /**
         * Support for `ref` type secret resolution
         */
        secret: {
            /**
             * @param {*} val -
