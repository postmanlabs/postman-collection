...
_.assignIn(Header.prototype, /** @lends Header.prototype */ {
    /**
...
_.assignIn(Header, /** @lends Header */ {
    ...
    size: function (headers, statusCode, reason) {
        ...
        var raw = HTTP_PLACEHOLDER + statusCode + SPC + reason + CRLF;
        raw += this.unparse(headers, CRLF);
        raw += (CRLF + CRLF);
        return raw.length;
    }
});
