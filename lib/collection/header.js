...
_.inherit((
     ...
     * @extends {Property}
     *
     * @param {Header~definition|String} options Pass the initial definition of the header (key, value) as the options parameter.
     * In case a string is given, it is parsed to extract the header key and value.
     *
