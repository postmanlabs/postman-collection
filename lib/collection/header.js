...
_.assign(Header, /** @lends Header */ {
    ...
    unparse: function (headers, separator) {
        ...
        return (Array.isArray(headers) ? headers : headers.members)
            .reduce(function (acc, header) {
                var unparsed = Header.unparseSingle(header);
                unparsed && acc.push(unparsed);
    ...
    unparseSingle: function (header) {
        if (!(_.isObject(header) && header.key && !header.disabled)) { return E; }
