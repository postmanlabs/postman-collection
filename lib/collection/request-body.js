var _ = require('../util').lodash,
    ...
    PROTOCOL_PROFILE_BEHAVIORS = [
        'disable-body-pruning' // disables body pruning for request methods like GET, HEAD etc.
    ];
...
_.assign(RequestBody.prototype, /** @lends RequestBody.prototype */ {
    ...
    update: function (options) {
        ...
        // Set protocolProfileBehavior to undefined for unknown behaviors
        !_.includes(PROTOCOL_PROFILE_BEHAVIORS, protocolProfileBehavior) && (protocolProfileBehavior = undefined);
        ...
        _.assign(this, /** @lends RequestBody.prototype */ {
            ...
            /**
             * Override standard behavior of parsing and sending request body.
             * @note this won't affect `disabled` property behavior.
             *
             * @type {String}
             */
